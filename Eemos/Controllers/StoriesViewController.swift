...
class StoriesViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.paraLabel.attributedText = attributedText1(indexPath: paraArray[indexPath.row])
    ...
    func attributedText(indexPath : String) -> NSAttributedString {
           ...
           let attributedString = NSMutableAttributedString(string: indexPath , attributes: [NSAttributedString.Key.font:UIFont.systemFont(ofSize: 18.0)])
   ...
   func attributedText1(indexPath : String) -> NSAttributedString {
      ...
      let attributedString = NSMutableAttributedString(string: indexPath
        , attributes: [NSAttributedString.Key.font:UIFont.systemFont(ofSize: 18.0),NSAttributedString.Key.paragraphStyle :style])

//    let boldFontAttribute = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 18.0),NSAttributedString.Key.paragraphStyle : style1]
//
//    let nsString =  indexPath as NSString
//      // Part of string to be bold
//   attributedString.addAttributes(boldFontAttribute, range: nsString.range(of: "“I feel that Eemos beauty parlor course has a huge impact on my life that helped me look at things and situations in a very different manner.” – Siva Kala"))
