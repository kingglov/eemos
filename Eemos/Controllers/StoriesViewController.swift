...
class StoriesViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    let imagesArray = StoriesConstants.imagesArray
    let headingsArray = StoriesConstants.headingsArray
    let paraArray = StoriesConstants.paraArray
    let boldParasArrays = StoriesConstants.boldParasArrays
    
    @IBOutlet weak var tableview: UITableView!
    
    var readSelected = Set<Int>() // stores the read more pressed rows
